...
class Ejecutora:
    ...
    def calcular_nomina_pilotos(self):
        ...
        if self.equipo1.piloto1.nombre == piloto_segunda_posición.nombre or self.equipo1.piloto2.nombre == piloto_segunda_posición.nombre:
...
pole = ejecutar.calcular_nomina_directores()
nomina_piloto = ejecutar.calcular_nomina_pilotos()
